<script>
	...
	// Our color set
	let values = [
		['#000000', '#990000', '#bf9000', '#38761d', '#0b5394', '#351c75', '#741b47'],
		['#323232', '#cc0000', '#f1c232', '#6aa84f', '#3d85c6', '#674ea7', '#a64d79'],
		['#4c4c4c', '#e06666', '#ffd966', '#93c47d', '#6fa8dc', '#8e7cc3', '#c27ba0'],
		['#ffffff', '#ea9999', '#ffe599', '#b6d7a8', '#9fc5e8', '#b4a7d6', '#d5a6bd']
  ]
